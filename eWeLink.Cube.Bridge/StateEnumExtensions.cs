...
public static class StateEnumExtensions
{
    ...
    public static Channel ToChannel(this ChannelId channelId)
    {
        return channelId switch
        {
            ChannelId.One => Channel.One,
            ChannelId.Two => Channel.Two,
            ChannelId.Three => Channel.Three,
            _ => throw new ArgumentOutOfRangeException(nameof(channelId), channelId, null)
        };
    }
    ...
    public static EWeLink.Api.Models.MotorCalibration ToMotorCalibration(this EWeLink.Cube.Api.Models.Capabilities.MotorCalibrationCapability capability)
    {
        return capability.Mode.ToMotorCalibration();
    }
    ...
    public static EWeLink.Api.Models.SwitchState ToSwitchState(this EWeLink.Cube.Api.Models.Capabilities.PowerCapability capability)
    {
        return capability.State.ToSwitchState();
    }
}